...
# =====================================
# 🔹 1. PCA con columnas numéricas
# =====================================
def apply_pca(data: pd.DataFrame, n_components: int, sample_size: int = 500):

    # Seleccionar solo columnas numéricas
    numeric_data = data.select_dtypes(include=['int64', 'float64'])

    # Eliminar NaN para evitar errores en PCA
...
# =====================================
# 🔹 2. Ejecutar KMeans, DBSCAN, Jerárquico
# =====================================
def run_clustering_algorithms(X_pca):
    ...
    try:
        ...
        results["agglomerative"] = {"labels": labels_aggl.tolist()}
    except Exception as e:
...
# =====================================
# 🔹 3. Agregar etiquetas de clusters
# =====================================
def attach_cluster_labels(data: pd.DataFrame, results: dict):
    ...
    data_out["cluster_hierarchical"] = results["hierarchical"]["labels"]
